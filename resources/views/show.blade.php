					...
					<div v-if="candidatesfromoffer != 0" class="contenedor-candidatos oferta">
						...
						<div class="card" v-for="candidate in candidatesfromoffer">
							...
							<div class="card-block">
								<h5 class="card-title">
									<span class="candidato-oferta">@{{candidate.tipo_id}} -</span> @{{candidate.id}}</h5>
								<h5>
									<span class="candidato-oferta">Estado Candidatura: </span>
									<span>@{{candidate.pivot.estado}}</span>
								</h5>
								<h5>
									<span class="candidato-oferta">Entrevista:</span>
									<span v-show="candidate.pivot.entrevista == 1"> SI || Fecha @{{ candidate.pivot.fecha_entrevista | moment}}</span>
									<span v-show="candidate.pivot.entrevista == 0"> NO</span>
								</h5>
								<h5>
									<span class="candidato-oferta">Observaciones: </span>
									<span>@{{candidate.pivot.observaciones}}</span>
								</h5>
							</div>
